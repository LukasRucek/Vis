...
public class WebRtc extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
            ...
            public void run() {
                try {
                    if(s.equals("CONNECTED")){
                        Toast.makeText(WebRtc.this, "CONNECTED", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
